...
public class AnalyzerUtilTest {
    ...
    public void displayToken_02() {
        Analyzer[] analyzers = {new MyMMSegAnalyzer(new File("data"), new String[]{"这是", ""}), new MMSegAnalyzer(new File("data")), new StandardAnalyzer(Version.LUCENE_35), new StopAnalyzer(Version.LUCENE_35), new SimpleAnalyzer(Version.LUCENE_35), new WhitespaceAnalyzer(Version.LUCENE_35)};
